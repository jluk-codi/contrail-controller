...
struct JsonData {
    class Constraint {
     public:
        typedef bool (tungsten_rapidjson::Value::*TypecheckFunc)() const;
    ...
    virtual bool ValidateJsonDocument(const tungsten_rapidjson::Value& document) = 0;
    virtual bool ParseFromJsonDocument(const tungsten_rapidjson::Value& document) = 0;
    virtual void EncodeJsonDocument(tungsten_rapidjson::Value* document,
        tungsten_rapidjson::Value::AllocatorType *allocator) = 0;
...
struct JsonConfig : public JsonData {
    ...
    bool ValidateJsonDocument(const tungsten_rapidjson::Value& document);
    bool ParseFromJsonDocument(const tungsten_rapidjson::Value& document);
    void EncodeJsonDocument(tungsten_rapidjson::Value* document,
...
struct JsonState : public JsonData {
    virtual bool ValidateJsonDocument(const tungsten_rapidjson::Value& document);
    virtual bool ParseFromJsonDocument(const tungsten_rapidjson::Value& document);
    void EncodeJsonDocument(tungsten_rapidjson::Value* document,
        tungsten_rapidjson::Value::AllocatorType *allocator);
