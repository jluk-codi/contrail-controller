...
# LOG_DISABLE=1 CONFIG_JSON_PARSER_TEST_DATA_FILE=/cs-shared/db_dumps/att_tungsten_db.json CONFIG_JSON_PARSER_TEST_INTROSPECT=5910 controller/src/ifmap/client/testdata/cassandra_to_json.rb
