...
def _issu_cassandra_pre_sync_main():
    ...
    logging.basicConfig(
        level=logging.INFO,
        filename='/var/log/tungsten/issu_tungsten_pre_sync.log',
    ...
    issu_cass_pre = ICCassandraClient(
        ...
        issu_tungsten_config.issu_info_pre, issu_tungsten_config.logger)
    issu_cass_pre.issu_merge_copy(
        issu_tungsten_config.issu_keyspace_config_db_uuid)
    issu_tungsten_config.lognprint("Done syncing Configdb uuid",
    ...
    issu_tungsten_config.lognprint("Done syncing svc-monitor keyspace",
                                   level=SandeshLevel.SYS_INFO)
    issu_cass_pre.issu_merge_copy(
        issu_tungsten_config.issu_keyspace_dm_keyspace)
