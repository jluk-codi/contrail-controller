...
class TestE2DM(test_case.DMTestCase):
    ...
    def test_dm_physical_router_mode_and_params(self):
        ...
        xml_config_str = '<config xmlns:xc="urn:ietf:params:xml:ns:netconf:base:1.0"><configuration><groups operation="replace"><name>__tungsten-e2__</name><snmp><interface>fxp0.0</interface><community><name>public</name><authorization>read-only</authorization></community><community><name>private</name><authorization>read-write</authorization></community></snmp><protocols><lldp><interface><name>all</name></interface></lldp><lldp-med><interface><name>all</name></interface></lldp-med></protocols></groups><apply-groups insert="first">__tungsten-e2__</apply-groups></configuration></config>'
