...
python add_virtual_dns.py --api_server_ip 10.204.216.39 --api_server_port 8082 --name con_vdns --domain_name default-domain --dns_domain tungsten.com --dyn_updates --record_order random --ttl 20001  --next_vdns vdns1 --floating_ip_record dashed-ip --external_visible --reverse_resolution
